...
public class SetupDatabaseIsinYear extends AppCompatActivity {
    ...
    //creating constant string variables
    ...
    public static final String EXTRA_DATE =
            "de.androidcrypto.gfgroomdatabaseown.EXTRA_DATE";
    public static final String EXTRA_DATA_YEAR =
            "de.androidcrypto.gfgroomdatabaseown.EXTRA_DATA_YEAR";
        ...
        generateDataset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < daysInYearWithoutWeenends.size(); i++) {
                    ...
                    //saveStockMovement("ETF Test", isin.toString(), date, year.toString());

                    StockMovementsModal model = new StockMovementsModal(date, date, "ETF " + isin.toString(), isin.toString(), "", "", "", "", "", "", "", "", year.toString(),"", "");
                    viewmodal.insert(model);

                    //StockMovementsModal bookingModel = new StockMovementsModal(date, "", year.toString(), isin.toString(), "", "", "", "", "", "", "", "", "", true);
    ...
    // todo append
    private void saveStockMovement(String stockName, String stockIsin, String date, String year) {
        ...
        data.putExtra(EXTRA_DATA_YEAR, year);
        ...
        System.out.println("stock movement was saved for " + date + " isin: " + stockIsin);
    }
